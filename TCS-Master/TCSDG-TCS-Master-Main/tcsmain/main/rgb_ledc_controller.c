...
static esp_err_t set_color(rgb_led_t *rgb_led, uint32_t color)
{
    ...
    ESP_RETURN_ON_ERROR(ledc_set_duty_and_update(LEDC_LOW_SPEED_MODE, rgb_led->red_channel, red, 0), TAG, "Failed to set red duty");
    ESP_RETURN_ON_ERROR(ledc_set_duty_and_update(LEDC_LOW_SPEED_MODE, rgb_led->green_channel, green, 0), TAG, "Failed to set green duty");
    ESP_RETURN_ON_ERROR(ledc_set_duty_and_update(LEDC_LOW_SPEED_MODE, rgb_led->blue_channel, blue, 0), TAG, "Failed to set blue duty");
